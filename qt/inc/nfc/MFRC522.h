/**
 * MFRC522.h - Library to use RFID MODULE KIT 13.56 MHZ WITH TAGS SPI W AND R with RPi.
 * Based on code Dr.Leong   ( WWW.B2CQSHOP.COM ), Miguel Balboa (circuitito.com), Søren Thing Andersen (access.thing.dk), and Tom Clement.
...
public: 
	...
	/////////////////////////////////////////////////////////////////////////////////////
	MFRC522(Comm* commType);
	MFRC522(Comm* commType, byte resetPowerDownPin);
        virtual ~MFRC522();
...
protected:
	Comm *PCDComm;			// Communication driver
        byte _resetPowerDownPin;	// RPi pin connected to MFRC522's reset and power down input (Pin 6, NRSTPD, active low)
